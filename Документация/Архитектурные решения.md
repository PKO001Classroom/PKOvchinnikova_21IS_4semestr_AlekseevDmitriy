# Архитектурное решение системы управления учебным процессом (упрощенный вариант)
...
- **Redis** для кэша и сессий (опционально, можно без него на старте)

### Фронтенд:
- **HTML/CSS/JavaScript** (ванильный, без сложных фреймворков)
- **Bootstrap 5** для адаптивного дизайна
- **HTMX** для AJAX-взаимодействий без сложного JS
